  ...
  const RSS20::Channel expectedChannel = RSS20::Channel(
          ...
          std::vector<RSS20::Item>(1,
              RSS20::Item("Why?", //title
                          ...
                          "", //author
                          { RSS20::Category("Example category", "https://cat.example.com/cats.php"),
                            RSS20::Category("Example category 2", "https://cat.example.com/cats2.php"),
                            RSS20::Category("Example category 3", "https://cat.example.com/cats3.php"),
                            RSS20::Category("Example category 4", "https://cat.example.com/cats4.php") }, //item categories
                          "", //comments
          ...
          0, //pubDate
          0, //lastBuildDate
          { RSS20::Category("Channel category", "https://channel.example.com/channel/"),
            RSS20::Category("Channel category, 2nd", "https://channel.example.com/channel/"),
            RSS20::Category("Channel category, 3rd", "https://channel.example.com/channel/") }, //channel categories
          "", //generator
          "", //docs
          RSS20::Cloud(), //cloud
          -1, //ttl
  ...
  if (!(feed == expectedChannel))
  {
    ...
    if (feed.items() != expectedChannel.items())
    {
      ...
      if (!(feedFirst.source() == expectedFirst.source()))
      {
        ...
        std::cout << "Expected source: " << expectedFirst.source().get() << std::endl
                  << "Parsed source:   " << feedFirst.source().get() << std::endl
                  << "Expected URL: " << expectedFirst.source().url() << std::endl
                  << "Parsed URL:   " << feedFirst.source().url() << std::endl;
      }
      return 1;
