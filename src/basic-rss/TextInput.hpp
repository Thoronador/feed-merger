...
#ifndef BASIC_RSS_TEXTINPUT_HPP
#define BASIC_RSS_TEXTINPUT_HPP

#include <string>

namespace BasicRSS
{
  /** \brief class to represent the textInput element of an RSS 0.91 or 2.0 channel
   *
