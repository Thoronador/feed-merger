...
int main(int argc, char ** argv)
{
  ...
  const RSS20::Channel expectedChannel = RSS20::Channel(
          ...
          RSS20::Image(), //image
          "", //rating
          RSS20::TextInput("TextInput Title", "Your software supports the textInput element. Why?", "thisIsTheName", "https://tx-in.example.com/script.php") //textInput
      );
  ...
  if (!(feed == expectedChannel))
  {
    ...
    //textInput
    if (!(feed.textInput() == expectedChannel.textInput()))
    {
      std::cout << "Error: Channel textInputs do not match!" << std::endl;
      return 1;
    }
    return 1;
  }
